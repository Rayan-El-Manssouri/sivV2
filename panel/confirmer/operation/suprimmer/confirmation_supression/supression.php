...
$query4 = "SELECT * FROM vehicule WHERE IdVehicule='".$IdVehicule."' ";
...
<header>
    ...
    <div class="formulaire">
        <?php foreach($data as $dataV2):  ?>
            <form method="post" style="display: inline; text-align: left;">
                ...
                <br>
                <div>
                    <span>Immatriculation du véhicule lier :</span>
                        <span><?= $Immatriculation?></span>
                </div>
                <div class="envoyer">
                    <input type="submit" value="Suprimmer" name="send" onclick="return confirm('Etes vous sure de vouloir le suprimmer ?')">
    ...
    <?php 
        if(isset($_POST['send'])){
            $query3 = "DELETE FROM `operation` WHERE IdOperation='".$IdOperation."' ";
