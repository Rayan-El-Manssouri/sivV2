...
<body>
        ...
        <select name="acheteur" id="pet-select">
                <option>--Séléctionner l'acheteur--</option>
                    <?php foreach($data as $dataV2):?>
                        <option  value="<?= $dataV2['Nom'] ?>"><?= $dataV2['RaisonSociale']  ?> </option>
                    <?php endforeach; ?>
        </select>
    ...
    if(isset($_POST['Mandat'])){
        ...
        header("location:../formalite_pdf/Mandat/traitement.php?Nature=Déclaration de cession");
    }
