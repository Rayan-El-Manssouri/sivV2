...
<form method="POST">
    <div>
                ...
                <div>
                   Raison social : <input type="text" placeholder="Raison social" name="RaisonSocial"> <br> <br>
                ...
                <span>Sélectionner une extension de la voie :</span> <select name="ExtensionDeLaVoie">
                <option name="ExtensionDeLaVoie" value="">Sélectionner une extension de la voie </option>
                <?php foreach($data2 as $dataV2): ?>
                    <option  value="<?= $dataV2['Nom'] ?>"><?= $dataV2['Nom'] ?></option>
                <?php endforeach; ?>
                </select><br><br>
                <span>Sélectionner une Type de voie adresse :</span> <select name="TypeDeVoieAdresse">
                 <option name="TypeDeVoieAdresse" value="">Sélectionner une Type de voie adresse </option>
