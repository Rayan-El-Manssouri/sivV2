    ...
    <div class="navigation">
        ...
        <nav>
            <ul>
                ...
                <li><a href="http://localhost/sivV2/public/connexion/confirmer/DeclarationAchat/GestionOperation/index.php?r=Operation"><button><span class="material-symbols-outlined">local_shipping</span>Opérations  <span style="position: relative; left: 15px; top: 0px;  padding: 5px; border-radius: 9px"><?php echo $totaloperation?></span></button> </a></li>
