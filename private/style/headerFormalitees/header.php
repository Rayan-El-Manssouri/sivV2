    ...
    <div class="navigation">
        ...
        <nav>
            <ul>
                ...
                <li><a href="http://localhost/sivV2/public/connexion/confirmer/DeclarationAchat/personne/"> <button> <span class="material-symbols-outlined">groups</span>Personnes</button> </a></li>
                <li><a href=""><button> <span class="material-symbols-outlined">directions_car</span>Véhicules</button> </a></li>
