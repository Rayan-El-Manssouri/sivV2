    ...
    <div class="navigation">
        ...
        <nav>
            <ul>
                ...
                <li><a href="http://localhost/sivV2/public/connexion/confirmer/DeclarationAchat/people/AjouterPersonne/"> <button> <span class="material-symbols-outlined">groups</span>Personnes <span style="position: relative; left: 15px; top: 0px;  padding: 5px; border-radius: 9px"><?php echo $total?></span></button> </a></li>
                <li><a href="http://localhost/sivV2/public/connexion/confirmer/DeclarationAchat/vehicle/"><button> <span class="material-symbols-outlined">directions_car</span>Véhicules <span style="position: relative; left: 15px; top: 0px;  padding: 5px; border-radius: 9px"><?php echo $countRecive[0]['COUNT(*)']?></span></button> </a></li>
                <li><a href="http://localhost/sivV2/public/connexion/confirmer/DeclarationAchat/deals/index.php?r=Operation"><button><span class="material-symbols-outlined">local_shipping</span>Opérations  <span style="position: relative; left: 15px; top: 0px;  padding: 5px; border-radius: 9px"><?php echo $totaloperation?></span></button> </a></li>
