...
if($V[0] == '1'){
    $query11 = "SELECT * FROM personnemoral WHERE IdPersonneMorale='".$V[1]."' ";
    $data11 = $database->read($query11);
...
<body>
    ...
    <div>
                        ...
                        <div>
                            ...
                            <select name="ville">
                                <option value="<?= $data9[0]['IdVille'] ?>"><?= $data9[0]['Nom'] ?></option>
                                <option value="">----------</option>
                                <?php 
                            ...
                            <option value=""><?= $Personne , $Nature ?></option>
                            <option value="">--------</option>
                            ...
                            <select name="vendeur">
                                <option value=""><?= $PersonneVendeur, $NatureVendeur ?></option>
                                <option value="">--------</option>
                                <option value="">Personne Physique</option>
                                <?php foreach($data5 as $dataV2): ?>
                                <option value="1, <?=$dataV2['IdPersonnePhysique']?>">
