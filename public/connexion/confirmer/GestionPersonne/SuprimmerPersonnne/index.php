...
<body>
    ...
    <div class="g_global">
        <h1>Bienvenue sur le panneau pour suprimmer une personne</h1>
        <br>
        <br>
    ...
    <script>
        $("#personne")
            .on("change", function(e){
                e.preventDefault();
                window.location.href = "http://localhost/siv/public/connexion/confirmer/ModifierPersonne/situation/" + $(this).val();
        })
    </script>
</body>
</html>